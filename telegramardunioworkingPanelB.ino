...
//Blue 0x0FC92
//Purple 0x6603A0
long int colorPrimary = 0xF06F00;

unsigned int listeningPort = 12113;
...
void sendOscNet() {
  if (sendValue != stopGap)
  {
    OscMessage msgPanelA("/panelB");      //identify ourselves as panel C
    msgPanelA.add(sendValue);             //attach the value we want to send
    oscUdp.send(msgPanelA, panelADest);   //send to panel A

    OscMessage msgPanelC("/panelB");      //identify ourselves as panel C
